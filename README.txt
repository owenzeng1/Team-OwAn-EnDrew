...
Update
Thus far, the only the map creating implementation is advanced enough to run well. 
The gameplay was delayed due to problems in class structure and organization. 
